            ...
            <div class="banner-inner text-white">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center mb-20" data-aos="fade-right" data-aos-delay="200"
                        ...
                        <li class="breadcrumb-item active">Visa Processes</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="section-title text-center counter-text-wrap mb-70" data-aos="fade-up"
                            data-aos-duration="1500" data-aos-offset="50">
                            <h2>Visa Processes for Your Convenience</h2>
                            <p>We provide personalized support with our visa processes, ensuring a seamless and hassle-free experience for our pilgrims</p>
                        </div>
                    </div>
                </div>
                <div class="container">
