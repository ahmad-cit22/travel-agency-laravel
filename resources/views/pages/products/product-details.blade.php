...
@section('content')
    ...
    <section class="product-details pt-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="product-details-images rmb-55" data-aos="fade-left" data-aos-duration="1500"
                        data-aos-offset="50">
                        <div class="tab-content preview-images">
                            <div class="tab-pane fade preview-item active show" id="preview1">
                                <img src="{{ asset('assets/images/shop/preview1.png') }}" alt="Preview">
                            </div>
                        ...
                        <div class="nav thumb-images rmb-20">
                            <a href="#preview1" data-bs-toggle="tab" class="thumb-item active show">
                                <img src="{{ asset('assets/images/shop/thumb1.png') }}" alt="Thumb">
                            </a>
                            <a href="#preview2" data-bs-toggle="tab" class="thumb-item">
                                <img src="{{ asset('assets/images/shop/thumb2.png') }}" alt="Thumb">
                            </a>
                            <a href="#preview3" data-bs-toggle="tab" class="thumb-item">
                                <img src="{{ asset('assets/images/shop/thumb3.png') }}" alt="Thumb">
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="product-details-content" data-aos="fade-right" data-aos-duration="1500"
                        data-aos-offset="50">
                        ...
                        <span class="price mb-25">$188.00</span>
                        <p>Our Cap is designed elevate your business operations with cutting-edge technology and
                            user-centric features. Crafted with precision, it offers seamless integration with existing
                            systems, ensuring a smooth transition and immediate impact has been meticulously</p>
                        <hr class="mt-40">
            ...
            <ul class="nav nav product-tab mt-70 mb-30" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                ...
                <li><a href="#information" data-bs-toggle="tab">Additional Information's <i
                            class="far fa-arrow-right"></i></a></li>
                <li><a href="#reviews" data-bs-toggle="tab"> Reviews <i class="far fa-arrow-right"></i></a></li>
            </ul>
            <div class="tab-content" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1500"
                data-aos-offset="50">
                <div class="tab-pane fade active show" id="details">
                    <p>Cap combines innovation and functionality to meet the demands of modern businesses. Engineered with
                        the latest technology, it offers robust features that streamline processes, enhance efficiency, and
                        deliver measurable results. Whether you're looking to boost productivity, improve customer
                        experiences, or gain deeper insights into your operations, [Product Name] is designed to provide the
                        solutions you need. With user-friendly interfaces and customizable options, it adapts to your unique
                        requirements, making it an essential tool for achieving your business goals. Discover the power of
                        [Product Name] and transform the way you work.</p>
                    <p>Our is designed to elevate your business operations with cutting-edge technology and user-centric
                        features. Crafted with precision, it offers seamless integration with your existing systems,
                        ensuring a smooth transition and immediate impact. Each aspect of [Product Name] has been
                        meticulously developed to address your specific needs, from enhancing productivity to optimizing
                        workflows. With a focus on reliability and performance, this product delivers consistent results
                    ...
                    <div class="row gap-50 pt-25 pb-20 align-items-center">
                        <div class="col-lg-7 pt-15">
                            ...
                            <p>Whether you're looking to boost productivity, improve customer experiences, or gain deeper
                                insights into your operations, [Product Name] is designed to provide the solutions you need.
                                With user-friendly interfaces and customizable options, it adapts to your unique
                                requirements</p>
                            <ul class="list-style-two mt-25">
                                <li>Assisting customers in booking domestic and international flights.</li>
                                <li>Organizing adventure activities such as trekking, diving, safaris, or extreme sports.
                                </li>
                        ...
                        <div class="col-lg-5">
                            <div class="image rmt-45">
                                <img src="{{ asset('assets/images/shop/product-details.jpg') }}" alt="Product Details">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="tab-pane fade" id="information">
                    <p>Circumstances occur in which toil and pain can procure him some great pleasure. To take a trivial
                        example, which of us ever undertakes laborious physical exercise, except to obtain some advantage
                        from it? But who has any right to find fault with a man who chooses</p>
                    <ul class="list-style-two my-35">
                        <li>Providing professional guides for city tours, cultural experiences, adventure activities, etc.
                        </li>
                        ...
                        <li>Register your business, obtain necessary licenses, and ensure compliance with local regulations.
                        </li>
                        <li>Build relationships with hotels, airlines, transport companies, and other service providers.
                        </li>
                    </ul>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consectetur quasi, atque! Repellat nihil
                        vero ipsam, ipsa tempore sint deleniti amet inventore tenetur iure, quia eum. Facere nostrum
                        veritatis nesciunt laudantium.</p>
                </div>
